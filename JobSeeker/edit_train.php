                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><span id="sprytextfield3">
                        <label>
                        <input type="text" name="title" id="txtName" value="<?php echo $row['title'];?>" />
                    ...
                    <tr>
                      ...
                      <td><span id="sprytextarea1">
                        <label>
                        <input type="text" name="inst" value="<?php echo $row['inst'];?>" />
                        </label>
                    ...
                    <tr>
                      ...
                      <td><span id="sprytextfield4">
                        <label>
                        <input type="text" name="st_date" id="txtCity" value="<?php echo $row['st_date'];?>"/>
                        </label>
                      <span class="textfieldRequiredMsg"></span></span></td>
                    </tr>
                    <tr>
                      ...
                      <td><span id="sprytextfield5">
                        <label>
                        <input type="text" name="end_date" id="txtEmail" value="<?php echo $row['end_date'];?>" />
                        </label>
                      <span class="textfieldRequiredMsg"></span></span></td>
                    </tr>
