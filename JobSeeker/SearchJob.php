                    ...
                    <td><table width="100%" border="1" cellpadding="1" cellspacing="2" bordercolor="#006699" >
                      <tr>
                        ...
                        <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Status</strong></div></th>
                         <th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong>Description</strong></div></th><th bgcolor="#006699" class="style3"><div align="left" class="style9 style5 style2"><strong> Call Letter</strong></div></th>
...
$sql = "SELECT job_master.JobId, job_master.CompanyName, job_master.JobTitle, application_master.Status, application_master.attach, application_master.JobSeekId, application_master.Description, application_master.ApplicationId
...
?>
                      <tr>
                        ...
                        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $JobTitle;?></strong></div></td>
                         <td class="style3" width="100"><div align="left" class="style9 style5"><strong><?php echo $Status;?></strong></div></td>
                         <td class="style3" width="100"><div align="left" class="style9 style5"><strong><?php echo $Description;?></strong></div></td>
						 <td class="style3" width="120"><div align="left" class="style9 style5"><strong><a href="../upload/<?php echo $attach;?>" target="_blank"><?php echo $attach;?></a></strong></div></td>
                         <td class="style3"><div align="left" class="style9 style5"><strong><a href="delete.php?id=<?php echo $id;?>">delete</a></strong></div></td>
                      </tr>
                      <?php
}
