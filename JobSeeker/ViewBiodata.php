...
?>
			  ...
			  <tr><td class="style3"><div align="left" class="style9 style5"><strong><?php if(!empty($logo)){?><img src="<?php echo $logo;?>"  width="100" height="50"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="+2" color="#0000FF">M.r&nbsp;&nbsp;<?php echo $_SESSION['Name'];?><?php }else{echo"Sorry No Logo Present";}?></strong></div></td></tr>
                  <tr>
