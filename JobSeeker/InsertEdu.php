...
session_start();
	...
	$sql = "INSERT INTO `job`.`jobseeker_education` (`EduId`, `JobSeekId`, `Degree`, `University`, `PassingYear`, `obt`, `tot`, `Percentage`) VALUES (NULL, '$Id', '$Degree', '$Uni', '$Passing', '$obt', '$tot', '$Per');";
	// execute query
	mysql_query ($sql,$con);
