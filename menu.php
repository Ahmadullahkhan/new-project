<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li><a href="gallery.php">Gallery<span class="tab-l"></span><span class="tab-r"></span></a></li>
				<li><a href="advanc.php">Search Job<span class="tab-l"></span><span class="tab-r"></span></a></li>
