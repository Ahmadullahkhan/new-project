                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td><span id="sprytextarea1">
                            <label>
                            <textarea name="txtDesc" id="txtDesc" cols="45" rows="15"></textarea>
                            </label>
                      ...
                      <tr>
                        ...
                        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Vacancy;?></strong></div></td>
                          <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $MinQualification;?></strong></div></td>
                            <td class="style3" rowspan="1" colspan="30"><div align="left" class="style9 style5"><strong><?php echo $Description;?></strong></div></td>
                      
                        <td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteJob.php?JobId=<?php echo $Id;?>">Delete</a></strong></div></td>
                        <td class="style3" align="center"><div align="left" class="style9 style5"><strong><a href="Edit_job.php?JobId=<?php echo $row['JobId']; ?>"><strong><img src="../design/13.jpg" width="15" /></strong></a></strong></div>
                      </tr>
                      <?php
}
