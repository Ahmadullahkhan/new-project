...
// Specify the query to Update Record
 $sql = "Update Application_Master set Status='".$Status."' ,Description='".$Description."',attach='".$path1."' where ApplicationId=".$AppId." and JobId='".$JobId."' and JobSeekId='".$JobSeekId."'";
//echo $sq="insert into Application_Master (attach) values ('".$path1."') where ApplicationId=$AppId";die;
// Execute query
mysql_query($sql,$con);
