   ...
   <td ><div id="vertmenu">
     <ul>
       ...
       <li><a href="Logout.php">Logout</a></li>
        ...
        <TD COLSPAN=2 valign="top"><br><br><table width="100%" border="1" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
          <tr bgcolor="#000000">
            <td width="96" valign="top" bgcolor="black" class="style2"><div align="left">Teacher Name </div></td>
            <td width="62" valign="top" bgcolor="black"" class="style2"><div align="center">Qualificatin</div></td>
            <td width="98" valign="top" bgcolor="black" class="style2"><div align="center">Mobile no </div></td>
            <td width="87" valign="top" bgcolor="black"" class="style2"><div align="center">Email </div></td>
            <td width="95" valign="top" bgcolor="black" class="style2"><div align="center">Picture</div></td>
            <td width="121" valign="top" bgcolor="black" class="style2"><div align="center">Change</div></td>
...
?>
          <tr>
            ...
            <td valign="top" bgcolor="#FFFFFF" class="style3"><div align="center"><a href="updateteacher.php?id=<?php echo $id ;?>">Update</a>| <a href="deleteteacher.php?id=<?php echo $id ;?>">Delete</a></div></td>
          </tr>
          <?php 
}
?>
