...
?>
  <tr  bgcolor="#0000FF">
    ...
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($top);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($cd);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($sd);?></td>
    
   
<td  bgcolor="pink"  valign="top" class="txt">
<?php echo "<a href='Deleteassignment.php?id=$id'>Delete </a>| <a href='updateassignment.php?id=$id'>Edit</a>";?>    </td>
  </tr>
  <?php
	}
?>
