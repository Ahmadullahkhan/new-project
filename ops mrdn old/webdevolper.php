...
<tr>
  <td ><img src="images/word_03.png" width="191" height="247"></td>
        ...
        <TD COLSPAN=2 valign="top"><table width="100%">
          <tr>
            <td colspan="5" class="style1">WELCOME TO ORIENTAL PUBLIC SCHOOL MARDAN </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td width="23%" rowspan="9"><img src="images/webmaster.jpg" width="128" height="140"></td>
            <td width="2%">&nbsp;</td>
            <td width="16%" class="newtitle">&nbsp;</td>
            <td width="58%" class="newtitle">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td class="newtitle">Name </td>
            <td class="newtitle">HAMID ALI</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td class="newtitle">Designation</td>
            <td class="newtitle">WEB DEVOLPER AND DESIGNER </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td class="newtitle">CELL#</td>
            <td class="newtitle">0344-9470064</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td class="newtitle">EMAIL</td>
            <td class="newtitle">hamidali_4u26@yahoo,com</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td width="1%">&nbsp;</td>
            <td colspan="4" rowspan="4"><img src="images/nne_03.png" width="479" height="300"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
