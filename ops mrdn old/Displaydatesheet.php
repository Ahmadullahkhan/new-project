...
?>
  <tr>
    ...
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($title);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($details);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($status);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($updated);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($eng);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($bio);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($chm);?></td>
    <td bgcolor="#FFFFFF"  valign="top" class="txt"><?php  echo($phy);?></td>
   
<td bgcolor="#FFFFFF"  valign="top" class="txt">
<?php echo "<a href='deletedatesheet.php?id=$id'>Delete </a>| <a href='updatedatesheet.php?id=$id'>Update</a>";?>    </td>
  </tr>
  <?php
	}
?>
