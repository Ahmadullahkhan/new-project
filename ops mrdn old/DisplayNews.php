...
<table width="97%" align="center" bgcolor="#E0E0E0">
  <tr>
    <td  valign="top" class="txt" width="14%">News Tilte </td>
    <td  valign="top" class="txt" width="28%">News Details </td>
    <td  valign="top" class="txt" width="17%">News Status </td>
    <td  valign="top" class="txt" width="18%">Last Updated </td>
    <td  valign="top" class="txt" width="23%">Action </td>
  </tr>
  <?php
...
<?php echo "<a href='Delete.php?id=$id'>Delete </a>| <a href='updatenews.php?id=$id'>Update</a>";?>    </td>
  </tr>
  <?php
	}
?>
