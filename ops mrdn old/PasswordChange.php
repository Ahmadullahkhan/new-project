...
if($new == $confirm)
{
$qry="SELECT * FROM login WHERE id='$id' and pascode='$old'";

$res=mysql_query($qry)or die("Can Not Find any Record".mysql_error());
	$count = mysql_num_rows($res);
	
	if ($count>0)
		{	
$qryUpt="UPDATE login SET pascode='$new' WHERE id = $id";
$resUpt=mysql_query($qryUpt) or die("Can not Process Update");
...
$status="New Password and Confirm Password are not equal!";
   ...
   <td ><div id="vertmenu">
     <ul>
       ...
       <li><a href="Logout.php">Logout</a></li>
        ...
        <TD COLSPAN=2 valign="top"><table width="47%" align="center">
          <tr>
            <td><form id="form1" name="form1" method="post" action="">
                <table width="518" border="0" align="center" cellpadding="0" cellspacing="5">
                  <tr>
                    <td width="224"><h2 class="style1">Change Password </h2></td>
                    <td width="279">&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="2"><div align="center" class="newtitle"><?php echo($status);?></div>
                        <div align="center"></div></td>
                  </tr>
                  <tr>
                    <td class="txt2">Old Password </td>
                    <td class="txt2"><input name="old" type="password" class="input" id="old" />
                    </td>
                  </tr>
                  <tr>
                    <td class="txt2"> New Password </td>
                    <td class="txt2"><input name="new" type="password" class="input" id="new" />
                    </td>
                  </tr>
                  <tr>
                    <td class="txt2">Re-Enter Password </td>
                    <td class="txt2"><input name="confirm" type="password" class="input" id="confirm" /></td>
                  </tr>
                  <tr>
                    <td class="txt2"></td>
                    <td class="txt2"><input name="Submit" type="submit" class="but" value="Change Password" /></td>
                  </tr>
                </table>
            </form></td>
          </tr>
