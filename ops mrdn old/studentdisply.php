   ...
   <td ><div id="vertmenu">
     <ul>
       ...
       <li><a href="Logout.php">Logout</a></li>
        ...
        <TD COLSPAN=2 valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
          <tr>
            <td width="96" valign="top" bgcolor="#CCCCCC" class="style2"><div align="left">Student Name </div></td>
            <td width="62" valign="top" bgcolor="#CCCCCC" class="style2"><div align="center">Class</div></td>
            <td width="98" valign="top" bgcolor="#CCCCCC" class="style2"><div align="center">Obtained MArks </div></td>
            <td width="87" valign="top" bgcolor="#CCCCCC" class="style2"><div align="center">Total Marks </div></td>
            <td width="95" valign="top" bgcolor="#CCCCCC" class="style2"><div align="center">Position</div></td>
            <td width="121" valign="top" bgcolor="#CCCCCC" class="style2"><div align="center">Year</div></td>
            <td width="121" valign="top" bgcolor="#CCCCCC" class="style2"><div align="center">Picture</div></td>
            <td width="121" valign="top" bgcolor="#CCCCCC" class="style2"><div align="center">Action</div></td>
          </tr>
          <?php 
...
?>
          <tr>
            ...
            <td valign="top" bgcolor="#FFFFFF" class="style3"><div align="center"><?php echo $class; ?></div></td>
            <td valign="top" bgcolor="#FFFFFF" class="style3"><div align="center"><?php echo $mobtain; ?></div></td>
            <td valign="top" bgcolor="#FFFFFF" class="style3"><div align="center"><?php echo $tmarks; ?></div></td>
            <td valign="top" bgcolor="#FFFFFF" class="style3"><div align="center"><?php echo $position; ?></div></td>
            <td valign="top" bgcolor="#FFFFFF" class="style3"><div align="center"><?php echo $year; ?></div></td>
            <td valign="top" bgcolor="#FFFFFF" class="style3"><img src='<?php echo $picture;?>' width="100" height="100"/></td>
            <td valign="top" bgcolor="#FFFFFF" class="style3"><div align="center"><a href="StudenUpdate.php?id=<?php echo $id ;?>">Update</a>| <a href="DeleteStudent.php?id=<?php echo $id ;?>">Delete</a></div></td>
          </tr>
          <?php 
}
?>
