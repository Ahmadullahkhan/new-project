...
$sd = mysql_real_escape_string($_POST['sd']);
if(empty($class)&& empty($sub) && empty($top)&& empty($cd)&& empty($sd))
{
...
$sql= "UPDATE assignment SET class='$class',sub='$sub',top='$top',cd='$cd',sd='$sd' WHERE id ='$id'";
//echo($sql);
        ...
        <tr>
          <td><form id="form1" name="form1" method="post" action="">
              <table width="100%">
                ...
                <tr>
                  <td width="34%" class="txt2">Class </td>
                  <td width="66%" class="txt2"><input name="class" type="text" id="PMF" size="40" value="<?php echo $class; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Subject</td>
                  <td class="txt2"><input name="sub" type="text" id="MMF" size="40" value="<?php echo $sub; ?>" /></td>
                </tr>
                <tr>
                  <td class="txt2">Topic </td>
                  <td class="txt2"><input name="top" type="text" id="SMF" size="40"  value="<?php echo $top; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Created Date</td>
                  <td class="txt2"><input name="cd" type="text" id="ADMNP" size="40"  value="<?php echo $cd; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Submission Date </td>
                  <td class="txt2"><input name="sd" type="text" id="SDMNM" size="40" value="<?php echo $sd; ?>" /></td>
                </tr>
               
                <tr>
                  <td><label>
                  <input name="Submit" type="submit" class="but" value="Save Assignment" />
                  </label></td>
