...
$sql= "UPDATE fee SET pmf ='$PMF',mmf='$MMF',smf='$SMF',admp='$ADMNP',admm='$SDMNM',adms='$ADMNS',ref='$REFUND',sports='$SPORT',lab='$LAB' WHERE id ='$id'";
//echo($sql);
          ...
          <td><form id="form1" name="form1" method="post" action="">
              <table width="100%">
                ...
                <tr>
                  ...
                  <td width="66%" class="txt2"><input name="PMF" type="text" id="PMF" size="40" value="<?php echo $PMF; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Middle Monthly Fee </td>
                  <td class="txt2"><input name="MMF" type="text" id="MMF" size="40" value="<?php echo $MMF; ?>" /></td>
                </tr>
                <tr>
                  <td class="txt2">Secondary Monthly Fee </td>
                  <td class="txt2"><input name="SMF" type="text" id="SMF" size="40"  value="<?php echo $SMF; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Admision Primery </td>
                  <td class="txt2"><input name="ADMNP" type="text" id="ADMNP" size="40"  value="<?php echo $ADMNP; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Admision Middle </td>
                  <td class="txt2"><input name="SDMNM" type="text" id="SDMNM" size="40" value="<?php echo $SDMNM; ?>" /></td>
                </tr>
                <tr>
                  <td class="txt2">Admision secondry </td>
                  <td class="txt2"><input name="ADMNS" type="text" id="ADMNS" size="40" value="<?php echo $ADMNS; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Refundable</td>
                  <td class="txt2"><input name="REFUND" type="text" id="REFUND" size="40" value="<?php echo $REFUND;  ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Sports</td>
                  <td class="txt2"><input name="SPORT" type="text" id="SPORT" size="40" value="<?php echo $SPORT; ?>"/></td>
                </tr>
                <tr>
                  <td class="txt2">Laboratory</td>
                  <td class="txt2"><input name="LAB" type="text" id="LAB" size="40"  value="<?php echo $LAB; ?>"/></td>
                </tr>
                <tr>
                  <td><label>
