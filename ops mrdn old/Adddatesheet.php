...
if(empty($class))
{
	...
	$status = "Please Fill In The Class Name !";
	
	}
else
{

$sql= "INSERT INTO datesheet(`id`,`class`,`urdu`,`islam`,`maths`,`sc`,`gk`,`eng`,`bio`,`chm`,`phy`) VALUES('','$class','$ud','$is','$mt','$sc','$gk','$eng','$bo','$ch','$ph')";
...
<form id="form1" name="form1" method="post" action="">
  <table width="84%" align="center" cellpadding="2">
    ...
    <tr>
      ...
      <td><input name="class" type="text" id="title" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">URDU &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="urdu" type="text" id="title" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">ISLAMYAT &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="islam" type="text" id="title" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">MATHS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="maths" type="text" id="title" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">SCIENCE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="sc" type="text" id="title" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">PAK-STUDY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="gk" type="text" id="title" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">ENGLISH &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="eng" type="text" id="title" size="35" /></td>
    </tr>
    
     <tr>
      <td class="txt">BIOLOGY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="bio" type="text" id="title" size="35" /></td>
    </tr>
    
     <tr>
      <td class="txt">CHEMISTRY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="chm" type="text" id="title" size="35" /></td>
    </tr>
  
     <tr>
      <td class="txt">PHYSICS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="phy" type="text" id="title" size="35" /></td>
    </tr>
      <tr>
      <TD>&nbsp;</TD>
      <td class="txt">INSERT DATE AS YEAR-MONTH-DAY </td>
      </tr>
