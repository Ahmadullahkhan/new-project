...
<tr>
  <td ><img src="images/word_03.png" width="191" height="247"></td>
        ...
        <TD COLSPAN=2 valign="top"><BR><table width="98%" border="1">
          <tr>
            <td colspan="9" class="style1"><h2 style="background-color:#000000">ASSIGNMENT LIST</h2></td>
          </tr>
          
          <tr bgcolor="#000000">
            <th width="10%" height="36">Class</th>
            <th width="12%">Subject</th>
            <th width="17%">Topic</th>
            <th width="26%">Created date</th>
            <th width="35%">Submission date</th>
...
echo("<tr bgcolor='BLUE'><td>$class</td>
<td> $sub</td><td> $top</td><td> $cd</td><td> $sd</td>
