...
*/
		...
		if(!empty($email)&&!empty($keycode))
		{		
				$sql ="SELECT * FROM login WHERE email='$email' AND secretcode='$keycode'";
				...
				if($count==1){
							...
							while($row=mysql_fetch_array($res))
							{
									...
									$show="Ur Record Is Not In our Database";
												}
				
	}

//ELSE{PLESA EMTER ALLTHE FIELDS}
				else
				{
						$show="please enter all the fields";
...
<form id="form1" name="form1" method="post" action="">
  <div align="center">
    <table width="400" border="0">
      <tr>
        <td colspan="2" class="txt">Forgotton Password </td>
      </tr>
      <tr>
        <td colspan="2" class="txt"> <span style="background-color:#CCCCCC; font-family:Georgia, 'Times New Roman', Times, serif;font-size :12px;color:#FF0000">
          <?php 
      ...
      <tr>
        <td width="105" class="txt">Email</td>
        <td width="285"><input name="email" type="text" id="email" /></td>
      </tr>
      <tr>
        <td class="txt">Secre tCode</td>
        <td><input name="keycode" type="text" id="keycode" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
