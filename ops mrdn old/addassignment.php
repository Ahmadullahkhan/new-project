...
$sql= "INSERT INTO assignment VALUES ('','$class','$sub','$top','$cd','$sd')";
//echo($sql);
...
<form id="form1" name="form1" method="post" action="">
  <table width="84%" align="center" cellpadding="2">
    <tr>
      <td colspan="2"><div align="center" class="abc"><strong><?php echo $status;?></strong></div></td>
    </tr>
    <tr>
      <td class="txt">CLASS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="class" type="text" id="abc" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">Subject&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="sub" type="text" id="abc" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">Topic&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="top" type="text" id="abc" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">Created Date &nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="cd" type="text" id="abc" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">Submission Date &nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="sd" type="text" id="abc" size="35" /></td>
    </tr>
      <tr>
      <TD>&nbsp;</TD>
    ...
    <tr>
      <td><input name="Submit" type="submit" class="but" value="Save Record" /></td>
