...
$upqry="UPDATE news SET title='$title',detail='$detail',status='$status', date=NOW() where id='$id'";
//echo()
$qryres=mysql_query($upqry) or die("can not execute query".mysql_error());
...
<form id="form1" name="form1" method="post" action="">
  <table width="93%" align="center" cellpadding="2">
    <tr>
      <td colspan="2"><div align="center" class="marqq"><strong><?php echo $show;?></strong></div></td>
    </tr>
    <tr>
      <td class="txt">News Title </td>
      <td><input name="title" type="text" id="title" size="35"  value="<?php echo $title;?>"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="status" type="text" id="status"  value="<?php echo $status;?>"/></td>
    </tr>
    <tr>
      <td><input name="Submit" type="submit" class="but" value="Update News" /></td>
