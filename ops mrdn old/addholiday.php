...
if(empty($event))
{
	...
	$status = "Please Fill In the event !";
	
	}
else
{

$sql= "INSERT INTO holiday VALUES ('','$event','$date')";
//echo($sql);
...
<form id="form1" name="form1" method="post" action="">
  <table width="84%" align="center" cellpadding="2">
    ...
    <tr>
      <td class="txt">Event&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="event" type="text" id="title" size="35" /></td>
    </tr>
     <tr>
      <td class="txt">Date&nbsp;&nbsp;&nbsp;&nbsp;* </td>
      <td><input name="date" type="text" id="title" size="35" /></td>
    </tr>
