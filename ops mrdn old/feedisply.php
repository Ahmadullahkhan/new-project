   ...
   <td ><div id="vertmenu">
     <ul>
       ...
       <li><a href="Logout.php">Logout</a></li>
        ...
        <TD COLSPAN=2 valign="top"><table width="94%" align="center" bgcolor="#CCCCCC">
          <tr>
            <td width="12%" height="22" class="txt2"><span class="style2">P. M. F </span></td>
            <td width="8%" class="txt2"><span class="style2">M.M.F</span></td>
            <td width="7%" class="txt2"><span class="style2">S.M.F</span></td>
            <td width="7%" class="txt2"><span class="style2">Ad.P</span></td>
            <td width="10%" class="txt2"><span class="style2">Ad.M</span></td>
            <td width="7%" class="txt2"><span class="style2">Ad.S</span></td>
            <td width="11%" class="txt2"><span class="style2">Refundable </span></td>
            <td width="8%" class="txt2"><span class="style2">Sports</span></td>
            <td width="12%" class="txt2"><span class="style2">laboratory</span></td>
            <td width="18%" class="txt2"><span class="style2">Action</span></td>
          </tr>
          <?php
...
?>
          <tr>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[1]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[2]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[3]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[4]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[5]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[6]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[7]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[8]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><?php echo $row[9]; ?></td>
            <td bgcolor="#FFFFFF" class="txt2"><a href="feeupdate.php?id=<?php echo $row[0];?>">Update Fee</a></td>
          </tr>
        </table></TD>
    </TR>
    <TR>
