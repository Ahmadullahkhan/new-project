                          ...
                          <table width="100%" border="0">
                            <tr>
                              ...
                              <td><span id="sprytextfield1">
                                <label>
                                <input name="NewsId" type="hidden" id="txtNewsId" value="<?php echo $Id;?>" />
                                </label>
                            ...
                            <tr>
                              ...
                              <td><span id="sprytextfield2">
                                <label>
                                <input name="News" type="text" id="txtNews" value="<?php echo $News;?>" />
                                </label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            <tr>
                              <td height="36"><span class="style8">Date:</span></td>
                              <td><span id="sprytextfield3">
                                <label>
                                <input name="NewsDate" type="text" id="txtPass" value="<?php echo $Date;?>" />
                                </label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            <tr>
