...
?>
                        <tr>
                          ...
                          <td class="style3"><div align="center" class="style9 style5"><strong><a href="DetailEmp.php?EmpId=<?php echo $Id;?>"><img src="design/det.png" width="20" height="15" /></a></strong></div></td>
                          <td class="style3"><div align="center" class="style9 style5"><strong><a href="delete_employer.php?EmpId=<?php echo $Id;?>"><img src="design/critical.gif" width="20" height="15" /></a></strong></div></td>
                        </tr>
                        <?php
}
