<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li><a href="ManageJob.php"> JobSeeker<span class="tab-l"></span><span class="tab-r"></span></a></li>
                ...
                <li><a href="add_gallery.php">Gallery<span class="tab-l"></span><span class="tab-r"></span></a></li>
